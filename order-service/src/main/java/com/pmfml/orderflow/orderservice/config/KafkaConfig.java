package com.pmfml.orderflow.orderservice.config;
...
/**
 * Kafka error-handling configuration for the Order Service.
 *
 * <p>If a consumer throws an exception (e.g. a transient database timeout),
 ...
 *
 * <p>This mirrors the configuration in {@code payment-service} and
 * {@code inventory-service} (see {@code ARCHITECTURE.md} §7.7).
 */
@Configuration
